...
const fetchQuestions = async (params) => await Axios.get(`https://mocktestdjango-production.herokuapp.com/ssc-cgl/${params.id}/`)
    .then(res => ({
        error: false,
        questions: res.data,
    }
...
export async function getStaticPaths() {
    ...
    const res = await fetch('https://mocktestdjango-production.herokuapp.com/ssc-cgl-testlist/')
