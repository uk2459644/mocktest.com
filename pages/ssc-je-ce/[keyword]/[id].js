...
const fetchQuestions = async (params) => await Axios.get(`https://backend-mock-test-crash.herokuapp.com/ssc-je-ce/${params.id}/`)
    .then(res => ({
        error: false,
        questions: res.data,
    }
...
export async function getStaticPaths() {
    ...
    const res = await fetch('https://backend-mock-test-crash.herokuapp.com/ssc-je-ce/')
