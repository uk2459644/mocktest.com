...
const fetchPrevTestList = async () => await Axios.get(`'${BACKEND_URL}/previous-year-ssc-je-ce/preview/'`)
    .then(res => ({
        error: false,
...
const fetchTestList = async () => await Axios.get(`'${BACKEND_URL}/ssc-je-ce/preview/'`)
    .then(res => ({
        error: false,
        testlist: res.data,
    }
