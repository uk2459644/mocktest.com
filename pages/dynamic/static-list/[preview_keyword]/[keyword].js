...
const fetchPrevTestList = async (params) => await Axios.get(`${BACKEND_URL}/${params.preview_keyword}/`)
    .then(res => ({
        error: false,
...
const fetchTestList = async (params) => await Axios.get(`${BACKEND_URL}/${params.keyword}/`)
    .then(res => ({
        error: false,
        testlist: res.data,
    }
