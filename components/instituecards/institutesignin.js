export default function InstituteSignInCard() {
  return (
    <div>
      <div class="flex items-center min-h-screen p-4 bg-black lg:justify-center">
        <div class="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
          <div class="p-4 py-6 text-white bg-blue-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
            <div class="my-3 text-4xl font-bold tracking-wider text-center">
              <a href="#">Institue Name</a>
            </div>
            <p class="mt-6 font-normal text-center text-gray-300 md:mt-0">
              For the students of coaching/institute name , who want tot access
              tests , notes and other stuffs of this coaching .
            </p>
            <p class="flex flex-col items-center justify-center mt-10 text-center">
              <span>Don't have an account?</span>
              <a href="/institute/coaching-contactus/contactus-index" class="underline">
                Contact Us!
              </a>
            </p>
