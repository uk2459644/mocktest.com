        ...
        <div className="max-w-xs bg-white shadow-lg rounded-lg overflow-hidden my-10">
            ...
            alt={item.name}/>
                <div className="flex items-center justify-between px-4 py-2 bg-gray-900">
                    <Link href={`/institute/coachings/${item.keyword}/${item.id}`}>
                    <button className="px-3 py-1 bg-gray-200 text-sm text-gray-900 font-semibold rounded">View Coachings</button>
                    </Link>
