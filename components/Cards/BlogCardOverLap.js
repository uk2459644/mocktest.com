        ...
        <div className="flex flex-col px-2 items-center -mt-16 md:-mt-32">
          <div className="flex flex-col rounded-lg bg-white p-4 sm:p-8 shadow-md w-full max-w-screen-sm mx-2 box-border ">
            ...
            <div className="mt-4 flex items-center">
              <img className="h-12 w-12 rounded-full mr-4" src="https://www.w3schools.com/howto/img_avatar.png"/>
              <div className="text-left flex-1">
                <p className="text-base font-medium">De Oliveira Tristan</p>
                <p className="text-sm text-gray-700">Jun 20, 2019</p>
              </div>
              <a href="https://codepen.io/tde-oliv" target="_blank" className="h-full w-auto flex items-center text-gray-600 p-4 self-end">
                <i className="fa fa-share" title="Find others from Tristan"></i>
              </a>
            </div>
            <p className="mt-5 text-gray-900">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sollicitudin enim urna, vitae porta nunc ullamcorper sit amet. Sed molestie ullamcorper nulla. className aptent taciti sociosqu ad litora torquent per.</p>
            <p className="mt-5 text-gray-900">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sollicitudin enim urna, vitae porta nunc ullamcorper sit amet. Sed molestie ullamcorper nulla. className aptent taciti sociosqu ad litora torquent per.</p>
            <p className="mt-5 text-gray-900">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sollicitudin enim urna, vitae porta nunc ullamcorper sit amet. Sed molestie ullamcorper nulla. className aptent taciti sociosqu ad litora torquent per.</p>
