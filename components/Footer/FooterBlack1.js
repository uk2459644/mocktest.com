            ...
            <footer className="md:hidden bg-black text-white">
                    ...
                    <div className="w-full mx-auto p-2">
                        <div className="tab w-full overflow-hidden">
                            ...
                            <div className={`tab-content overflow-hidden leading-normal`}>
                                <ul className={`${isOn1 ? 'block' : 'hidden'} w-full flex flex-col text-gray-700 list-none p-0 font-thin text-left`}>
                                    ...
                                    <li><a href="#" className="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">RRB </a></li>
                                    <li><a href="#" className="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">SSC </a></li>
                                    <li><a href="#" className="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Boards </a></li>
                        ...
                        <div className="tab w-full overflow-hidden">
                            ...
                            <li><a href="#" className="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Features</a></li>
                                    ...
                                    <li><a href="#" className="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Terms of Services</a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="border-t border-yellow-800 flex flex-col md:flex-row justify-center items-center p-6 mt-4 text-yellow-600">
                    <div className="social w-full mx-5 my-5 flex justify-center text-center">
                        <a className="block  items-center text-gray-300 hover:text-white mr-6 no-underline" href="#">
                        ...
                        <a className="block  items-center text-gray-300 hover:text-white no-underline" href="#">
                            <svg viewBox="0 0 24 24" className="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>© 2020 Nomination Required Agency LLC.</div>
